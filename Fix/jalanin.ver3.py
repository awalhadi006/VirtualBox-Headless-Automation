...
subprocess.Popen([r"D:\Project\Virtual Box Automation\Fix\Buka Vbox.exe"])

# Menunggu sebentar untuk memastikan VM telah dimulai
time.sleep(27)

# Mengirimkan kunci ke virtual mesin (ctrl)
subprocess.run(["C:/Program Files/Oracle/VirtualBox/VBoxManage.exe", "controlvm", VM_UUID, "keyboardputscancode", "1d", "9d"])
time.sleep(1)
